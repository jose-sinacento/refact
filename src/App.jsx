...
function App() {
  ...
  function mostrarEmpleadosBonito(empleados) {
    return empleados.map((empleado) => 
    <div key={empleado}>
      <li>
        <h2>Nombre: {empleado.name}</h2>
        <h3>Apellidos: {empleado.lastName}</h3>
  ...
  return (
    ...
    <div className='envoltura'>
      ...
      <div className='empleados'>
        {mostrarEmpleadosBonito(empleados)}
      </div>

      <div className='calculadora'>
        <h1>Calculadora para flojos</h1>
        <Calculadora />
      </div>
    </div>
